$(document).ready(function() {
    ...
    $(".js--pic-6").waypoint(function(direction) {
        $(".js--pic-6").addClass("fadeInUpBig").css("opacity", "1");
    }, {
        offset: "60%"
    ...
    $(".js--pic-8").waypoint(function(direction) {
        $(".js--pic-8").addClass("fadeInUpBig").css("opacity", "1");
    }, {
        offset: "60%"
    });  

    $(".js--pic-9").waypoint(function(direction) {
        $(".js--pic-9").addClass("SlideInRight").css("opacity", "1");
    }, {
        offset: "55%"
    });  
